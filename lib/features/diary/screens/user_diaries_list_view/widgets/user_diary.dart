...
import 'package:rumo/features/diary/screens/user_diaries_list_view/user_diaries_details.dart';
...
class UserDiary extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, ref) => InkWell(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => UserDiariesDetails(diaryId: diary.id),
        ),
      );
    },
    child: Container(
